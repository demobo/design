...
if($config['subscription_email']['enabled'] && !empty($config['name']) && !empty($config['email']) && !empty($config['subscription_email']['subject']) && !empty($config['subscription_email']['message'])) {
